...
import DetailVehicleInfo from '../../../molecules/stPurchase/detailVehicleInfo';
    ...
    render() {
        ...
        return (
            <ScrollLayout>
                ...
                <DetailVehicleInfo
                    inputCarNumFunc={(text: string) => inputCarNumFunc(text)}
                    inputNameFunc={(text: string) => inputNameFunc(text)}
                    inputPhoneNumFunc={(text: string) => inputPhoneNumFunc(text)}
                />
                <DetailDescription />
                <DetailTermsButton
                    text={"상품고시정보"}
